...
var acceptorTests = []struct {
		...
		[]acceptorAction{
			{
				...
				wantOutput: true,
				wantPrm: Promise{ To:   2, From: 0, Rnd:  2, },
			},
			{
		...
		[]acceptorAction{
			{
				...
				wantOutput: true,
				wantPrm: Promise{ To:   2, From: 0, Rnd:  0, },
			},
		},
	},
	{
		...
		[]acceptorAction{
			{
				...
				msgtype: accept,
				accept: Accept{ From: 2, Slot: 1, Rnd:  2, Val:  testingValueThree, },
				wantOutput: true,
				wantLrn: Learn{ From: 0, Slot: 1, Rnd:  2, Val:  testingValueThree, },
			},
			{
		...
		[]acceptorAction{
			{
				...
				wantOutput: true,
				wantPrm: Promise{ To:   1, From: 0, Rnd:  1,},
			},
			{
	...
	},
	{
		...
		[]acceptorAction{
			...
			},
			{
				...
				msgtype: accept,
				accept: Accept{ From: 2, Slot: 1, Rnd:  2, Val:  testingValueOne, },
				wantOutput: true,
				wantLrn: Learn{ From: 0, Slot: 1, Rnd:  2, Val:  testingValueOne, },
			},
			{
				...
				wantOutput: true,
				wantPrm: Promise{ To: 1, From: 0, Rnd:  3, Slots: []PromiseSlot{ { ID:   1, Vrnd: 2, Vval: testingValueOne,},},},
			},
		},
	},
	{
		...
		[]acceptorAction{
			...
			},
			{
				...
				msgtype: accept,
				accept: Accept{ From: 2, Slot: 1, Rnd:  5, Val:  testingValueTwo, },
				wantOutput: true,
				wantLrn: Learn{ From: 0, Slot: 1, Rnd:  5, Val:  testingValueTwo, },
			},
			{
				desc:    "accept for slot 2 with _higher_ rnd -> output correct learn",
				msgtype: accept,
				accept: Accept{ From: 2, Slot: 2, Rnd:  8, Val:  testingValueThree, },
				wantOutput: true,
				wantLrn: Learn{ From: 0, Slot: 2, Rnd:  8, Val:  testingValueThree, },
			},
		},
	},
	{
		...
		[]acceptorAction{
			{
				...
				wantOutput: true,
				wantPrm: Promise{ To:   1, From: 0, Rnd:  4, },
			},
			{
	...
	},
	{
		...
		[]acceptorAction{
			...
			{
				desc:    "accept for slot 3, rnd 2 -> output learn with correct slot, rnd and value",
				msgtype: accept,
				accept: Accept{ From: 2, Slot: 3, Rnd:  2, Val:  testingValueTwo, },
				wantOutput: true,
				wantLrn: Learn{ From: 0, Slot: 3, Rnd:  2, Val:  testingValueTwo, },
			},
			{
				desc:    "accept for slot 4, rnd 2 -> output learn with correct slot, rnd and value",
				msgtype: accept,
				accept: Accept{ From: 2, Slot: 4, Rnd:  2, Val:  testingValueThree, },
				wantOutput: true,
				wantLrn: Learn{ From: 0, Slot: 4, Rnd:  2, Val:  testingValueThree, },
			},
			{
				...
				wantOutput: true,
				wantPrm: Promise{ To: 1, From: 0, Rnd: 3, Slots: []PromiseSlot{ { ID:   3, Vrnd: 2, Vval: testingValueTwo,}, { ID:   4, Vrnd: 2, Vval: testingValueThree, }, },},
			},
		},
	},
	{
		...
		[]acceptorAction{
			...
			},
			{
				...
				msgtype: accept,
				accept: Accept{ From: 1, Slot: 3, Rnd:  1, Val:  testingValueTwo, },
				wantOutput: false,
			},
			{
			...
			},
			{
				...
				msgtype: accept,
				accept: Accept{ From: 2, Slot: 5, Rnd:  5, Val:  testingValueOne, },
				wantOutput: true,
				wantLrn: Learn{ From: 0, Slot: 5, Rnd:  5, Val:  testingValueOne, },
			},
			{
				desc:    "accept for slot 7 with old lower rnd (1) -> no output, ignore accept",
				msgtype: accept,
				accept: Accept{ From: 1, Slot: 7, Rnd:  1, Val:  testingValueTwo, },
				wantOutput: false,
			},
			{
				...
				wantOutput: true,
				wantPrm: Promise{ To: 1, From: 0, Rnd: 7, Slots: []PromiseSlot{ { ID:   4, Vrnd: 2, Vval: testingValueThree,},{ ID: 5, Vrnd: 5, Vval: testingValueOne, }, }, },
			},
		},
	},
	{
		...
		[]acceptorAction{
			...
			},
			{
				...
				msgtype: accept,
				accept: Accept{ From: 2, Slot: 6, Rnd:  5, Val:  testingValueOne, },
				wantOutput: true,
				wantLrn: Learn{ From: 0, Slot: 6, Rnd:  5, Val:  testingValueOne, },
			},
			{
				desc:    "accept for slot 7 with old lower rnd (1) -> no output, ignore accept",
				msgtype: accept,
			...
			},
			{
				...
				prepare: Prepare{ From: 1, Slot: 2, Crnd: 7,},
				wantOutput: true,
				wantPrm: Promise{ To: 1, From: 0, Rnd: 7, Slots: []PromiseSlot{{ ID:   4, Vrnd: 2, Vval: testingValueThree,},{ID: 6, Vrnd: 5, Vval: testingValueOne, }, }, },
			},
		},
	},
	{
		...
		[]acceptorAction{
			...
			},
			{
				...
				msgtype: accept,
				accept: Accept{ From: 2, Slot: 1, Rnd:  5, Val:  testingValueOne, },
				wantOutput: true,
				wantLrn: Learn{ From: 0, Slot: 1, Rnd:  5, Val:  testingValueOne, },
			},
			{
				desc:    "accept for slot 3, with different sender and lower round -> no output, ignore accept",
				msgtype: accept,
			...
			},
			{
				...
				msgtype: accept,
				accept: Accept{ From: 2, Slot: 4, Rnd:  5, Val:  testingValueThree, },
				wantOutput: true,
				wantLrn: Learn{ From: 0, Slot: 4, Rnd:  5, Val:  testingValueThree, },
			},
			{
				desc:    "accept again for slot 4, with _higher_ round, rnd 8 -> output correct learn",
				msgtype: accept,
				accept: Accept{ From: 2, Slot: 4, Rnd:  8, Val:  testingValueThree, },
				wantOutput: true,
				wantLrn: Learn{ From: 0, Slot: 4, Rnd:  8, Val:  testingValueThree, },
			},
			{
				desc:    "accept for slot 6 with _higher_ rnd (11) -> output correct learn",
				msgtype: accept,
				accept: Accept{ From: 2, Slot: 6, Rnd:  11, Val:  testingValueOne, },
				wantOutput: true,
				wantLrn: Learn{ From: 0, Slot: 6, Rnd:  11, Val:  testingValueOne, },
			},
			{
				desc:    "accept for slot 7 with old lower rnd (1) -> no output, ignore accept",
				msgtype: accept,
			...
			},
			{
				...
				wantOutput: true,
				wantPrm: Promise{ To: 1, From: 0, Rnd: 13, Slots: []PromiseSlot{ { ID: 4, Vrnd: 8, Vval: testingValueThree,},{ID: 6, Vrnd: 11, Vval: testingValueOne,},},},
			},
		},
	},
	{
		...
		[]acceptorAction{
			...
			},
			{
				desc:    "accept for slot 2 with _higher_ rnd -> output correct learn",
				msgtype: accept,
				accept: Accept{ From: 2, Slot: 2, Rnd:  5, Val:  testingValueThree, },
				wantOutput: true,
				wantLrn: Learn{ From: 0, Slot: 2, Rnd:  5, Val:  testingValueThree, },
			},
			{
				desc:    "accept for slot 1 again with _higher_ rnd after we previously have sent accept for slot 2 -> output correct learn",
				msgtype: accept,
				accept: Accept{ From: 2, Slot: 1, Rnd:  8, Val:  testingValueTwo, },
				wantOutput: true,
				wantLrn: Learn{ From: 0, Slot: 1, Rnd:  8, Val:  testingValueTwo, },
			},
		},
	},
}
