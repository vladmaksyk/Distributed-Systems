...
func (t Transaction) String() string {
	...
	case Transfer:
		return fmt.Sprintf("%s transaction from account %d to account %d: amount %d NOK", t.Op, t.From.Number, t.To.Number, t.Amount)
	default:
...
func (a *Account) Process(txn Transaction) TransactionResult {
	...
	return TransactionResult{a.Number,a.Balance,err,}
}
